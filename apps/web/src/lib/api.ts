...
const defaults: AppSettings = { mode: 'safe', updateTags: false, artwork: false, preserveArtwork: true, preferLossless: true, language: 'es', theme: 'light', provider: { musicbrainzEnabled: false, openaiEnabled: false, webSearchEnabled: false, openaiConfigured: false, model: null, maxRequests: 100, maxWebRequests: 10 } };
